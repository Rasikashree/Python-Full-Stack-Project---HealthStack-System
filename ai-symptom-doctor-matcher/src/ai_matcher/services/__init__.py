...
# // Load symptoms for the selected category
...
# // Finalize symptoms and fetch doctor recommendations
...
# // Fetch doctor recommendations based on selected symptoms
...
#     } else {
#       appendMessage('bot', 'No matching doctors found.');
#     }
#   })
#   .catch(() => {
...
# // Render doctor buttons for selection
