...
class Admin_Information(models.Model):
    ...
    user = models.OneToOneField('hospital.User', on_delete=models.CASCADE, null=True, blank=True, related_name='hospital_admin')
    ...
    hospital = models.ForeignKey('hospital.Hospital_Information', on_delete=models.SET_NULL, null=True, blank=True)
...
class Clinical_Laboratory_Technician(models.Model):
    ...
    user = models.OneToOneField('hospital.User', on_delete=models.CASCADE, null=True, blank=True, related_name='technician')
    name = models.CharField(max_length=200, null=True, blank=True)
...
class hospital_department(models.Model):
    ...
    hospital = models.ForeignKey('hospital.Hospital_Information', on_delete=models.CASCADE, null=True, blank=True)
    featured_image = models.ImageField(upload_to='departments/', default='departments/default.png', null=True, blank=True)

    def __str__(self):
        val1 = str(self.hospital_department_name or self.name)
...
class specialization(models.Model):
    ...
    hospital = models.ForeignKey(
        ...
        null=True,
        blank=True,
        related_name='admin_specializations'  # <-- unique related_name
    )
